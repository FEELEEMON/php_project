...
<body>
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'boaddavid1@gmail.com'; // Replace with your email
        $mail->Password   = 'tskaxbwdehnzeqtx'; // Use an App Password, not a real password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
        $mail->Port       = 587;
        $mail->setFrom('boaddavid1@gmail.com', 'Library Management System');
    } catch (Exception $e) {
