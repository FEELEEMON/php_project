...
<html>
	...
	<body>
		<form class="cd-form" method="POST" action="#">
			...
			<p align="center">Don't have an account?&nbsp;<a href="register.php" style="text-decoration:none; color:red;">Register Now!</a></p>
	...
	<?php
		if(isset($_POST['m_login']))
		{
			...
			if(mysqli_num_rows($result) != 1) {
				...
				$resultRow = $result->fetch_array(); // Fetch the result as an array
				$balance = $resultRow['balance']; // Use column name for better readability
				if($balance < 0) {
					echo error_without_field("Your account has been suspended. Please contact librarian for further information!");
				} else {
					$_SESSION['type'] = "member";
					$_SESSION['id'] = $resultRow['id']; // Use column name for better readability
